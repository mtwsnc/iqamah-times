...
import { formatTo12Hour, getTimeValueDate } from "@/lib/prayer-time"
import type { IqamahTimes, PrayerData, PrayerTime } from "@/types/prayer"
...
export default function PrayerTimesDisplay({
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      const now = new Date()
      const targetTime = isIqamahCountdown
    ...
    <>
      {showBanner && (
        <div className="app-banner flex">
          ...
          <a href="/MTWS%20Iqaamah%20Times.apk" className="app-banner-download">
            Download
          </a>
      ...
      <div className="page-content">
        ...
        <main className="container mx-auto px-4 pb-8">
            ...
            <div className="flex items-center justify-center gap-2">
              ...
              <div className="tooltip mb-1">
                ...
                <span className="tooltip-text">
                  Official Prayer Times Source
                </span>
              </div>
            </div>
            <p className="text-sm opacity-90">
              3714 South Alston Avenue, Durham, NC, USA
            </p>
          </div>
          ...
          <div className="mt-8 text-center download-buttons flex flex-wrap justify-center gap-2">
            <a
              href="/MTWS%20Iqaamah%20Times.apk"
...
function PrayerCard({
  ...
  return (
    <div
      className={`prayer-card flex flex-col h-full ${isActive ? "active" : ""}`}
    >
